...
export default function Germany(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg class="w-4 h-auto" {...props} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
